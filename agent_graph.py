...
1. STRUCTURE:
   ...
   - Vehicle details (bulleted points)
   - Related vehicles/sellers (if applicable)

2. CONTENT:
   - Always include prices in Rs format (e.g., Rs 5,500,000)
...
4. UNCERTAINTY HANDLING:
   ...
   - If missing data: "Please contact seller for [missing info]"
   - If price negotiable: "Price is negotiable"
